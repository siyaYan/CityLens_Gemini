...
3. free_api version need huggingface token, set `HF_API_TOKEN`, and `HF_IMAGE_MODEL_ID`=`black-forest-labs/FLUX.1-Krea-dev` , and replace all `geminiService_paid` to `geminiService_free`
4. Run the app:
   `npm run dev`
